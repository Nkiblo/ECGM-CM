...
class FinishedProjectsAdapter(private var projects: List<Project>) : RecyclerView.Adapter<FinishedProjectsAdapter.ProjectViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProjectViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, FinishedProjectActivity::class.java)
